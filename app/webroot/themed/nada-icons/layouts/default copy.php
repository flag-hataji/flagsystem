...
<div id="Page">
    <div id="Wrap" class="clearfix">
        ...
        <div id="Beta">
            ...
            <?php if($bcBaser->isTop()): ?>
            <div id="top-main">
                <?php $bcBaser->img('./slider/main.png'); ?>
<!--
                <div id="slider">
...
-->
            ...
            */
            ...
            <div id="top-contents-main">
                <div class="fb-like-box" data-href="https://www.facebook.com/flagsystem" data-width="730" data-show-faces="true" data-stream="true" data-show-border="true" data-header="true"></div>
            </div>
